...
//Database pages//
route::get('/mysql', 'App\Http\Controllers\pagesController@angular');
route::get('/dynamodb', 'App\Http\Controllers\pagesController@reactjs');
route::get('/postgresql', 'App\Http\Controllers\pagesController@vue');
route::get('/oracle', 'App\Http\Controllers\pagesController@typescript');
route::get('/mongodb', 'App\Http\Controllers\pagesController@wpf');
route::get('/reddis', 'App\Http\Controllers\pagesController@html5');
