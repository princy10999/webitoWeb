...
route::get('/wordpress', 'App\Http\Controllers\pagesController@wordpress');
route::get('/shopify', 'App\Http\Controllers\pagesController@shopify');
route::get('/umbraco', 'App\Http\Controllers\pagesController@umbraco');
route::get('/drupal', 'App\Http\Controllers\pagesController@drupal');
route::get('/selenium', 'App\Http\Controllers\pagesController@joomla');
