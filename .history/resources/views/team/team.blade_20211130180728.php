...
@section('teampage-contain')
    ...
    {{-- </head> --}}
    {{-- <body class="loading"> --}}
    <main id="team-page-main-sec" style="display: flex; flex-direction: row;">
        {{-- <div class="message">
    ...
    <div class="frame">
      ...
      <div class="frame__links">
        ...
        <div class="content" style="display: flex" style="flex-direction: row">
            ...
            <div class="grid">
                ...
                <a href="#preview-4" class="grid__item pos-4" data-title="<img src='../../assets/img/team/ironman1.webp'>">
                ...
                <div class="preview__item" id="preview-8">
                    ...
                    <div class="preview__item-imgwrap">
                        <div class="preview__item-img"
                            style="background-image: url(../../assets/img/team/rushikesh1.webp)">
                        </div>
                    </div>
