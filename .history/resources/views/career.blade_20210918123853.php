...
@section('homepage-contain')
    <link href="assets/css/carer.css" rel="stylesheet">
    <section class="main-page-header">
        <div class="container">
            <div class="page-header-content careers-content-block">
                <h1>Become a Part of IndiaNIC Family</h1>
                <p>Joining IndiaNIC could be your life changing decision in doing so with endless goodies
                ...
                <h3>We hire character. Train skill.</h3><span>– Peter Schutz</span>
                <!---->
            </div>
        </div>
    </section>
