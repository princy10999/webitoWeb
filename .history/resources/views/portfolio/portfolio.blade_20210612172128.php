...
@section('portfoliocontent')
    ...
    <div class="container">
        <div class="card-slider">
          ...
          <div class="col-lg-12">
            <div class="card">
              <img class="card-img-top" src="../assets/img/Portfolio/app/JKR_Dark.png" alt="Card image cap">
              <div class="card-body">
                <h5 class="card-title">Card title</h5>
                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                <a href="#" class="btn btn-primary">Go somewhere</a>
          ...
          <div class="col-lg-12">
            <div class="card w-100">
              <img class="card-img-top img-fluid" src="../assets/img/Portfolio/app/JKR_Light.png" alt="Card image cap">
              <div class="card-body">
                <h5 class="card-title">Card title</h5>
                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                <a href="#" class="btn btn-primary">Go somewhere</a>
          ...
          <div class="col-lg-12">
            <div class="card w-100">
              <img class="card-img-top" src="../assets/img/Portfolio/app/Vishwakarma_app.png" alt="Card image cap">
              <div class="card-body">
                <h5 class="card-title">Card title</h5>
                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                <a href="#" class="btn btn-primary">Go somewhere</a>
          ...
          <div class="col-lg-12">
            <div class="card w-100">
              <img class="card-img-top" src="../assets/img/Portfolio/app/Mockup.png" alt="Card image cap">
              <div class="card-body">
                <h5 class="card-title">Card title</h5>
                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                <a href="#" class="btn btn-primary">Go somewhere</a>
