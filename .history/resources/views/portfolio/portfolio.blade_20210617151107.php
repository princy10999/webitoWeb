        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="featured-carousel owl-carousel">
                        ...
                        <div class="work">
                            <div  class="img d-flex align-items-end justify-content-center" style="background-image: url(assets/img/Portfolio/design/JKR/jkr_dark.png) ; alt: JKR;">
                                <div class="text w-100">
                                    <a href="/portfolio_page" class="cat">Web Design</a>
                    ...
                    <div class="item">
                        <div class="work">
                            <div class="img d-flex align-items-end justify-content-center" style="background-image: url(assets/img/Portfolio/design/JKR/jkr_light.png); ">
                                <div class="text w-100">
                                    <a href="" alt="" class="cat" alt="">Web Design</a>
                    ...
                    <div class="item">
                        <div class="work">
                            <div class="img d-flex align-items-end justify-content-center" style="background-image: url(assets/img/Portfolio/design/JKR/Mokup-7.png);">
                                <div class="text w-100">
