...
@section('mobileapp-contain')
    ...
    $desc = 'Webito is a top website design and web development company in India delivering the best web development
                                                                                                    services to craft bespoke websites, web applications, web-tools, etc. to global businesses and startups with 100%
                                                                                                    project delivery.';
    ?>
    ...
    $helpparagraph1 = 'We ship rich experiences to the small screens, which translates into the success of your
                                                                                                    business, ease of operations and engagement of the consumers with our exceptionally deep understanding of user
                                                                                                    experience and mobile technology. We work with multiple ecosystems in order to create maximum impact to your
                                                                                                    end-users.';
    $helpparagraph2 = '';
    $helpappsimg = '';
    $icon1 = '';
