...
@section('devops-contain')
    ...
    <section id="devops-secondsection">
        <div class="container">
            <div class="devops-section-inner">
                <h2>In the modern-day to have continuous and progressive builds for application delivery – it is
                ...
                <h4>Webito, a leading DevOps Consulting & DevOps Services providing Company, enables delivering large
                    ...
                    consistent ecosystem and operational workflow.</h4>
    ...
    $desc = 'Our efficient and well planned DevOps orchestration strategy makes this possible by combining business
        ...
        DevOps consultation.';
    $image = 'assets/img/services/devops/img-devops-setup-white.png';
    ?>
    ...
    $desc = 'We combine DevOps practices with AWS services, for a more rapidly and reliably build and deliver
        products.';
    $image = 'assets/img/services/devops/img-devops-aws-black.png';
    ?>
    @include('services.common.planning')
    ...
    $image = 'assets/img/services/devops/devops-azure-img-black.png';
    ?>
    @include('services.common.planning')
            ...
            <div class="mobile-app-services">
                <div class="row">
                    <div class="col-lg-4 col-sm-12 col-md-12  mobile-app-col">
                        <div class="services-icon"><img src="assets/img/services/devops/google-cloud.png" /></div>
                    </div>
                    <div class="col-lg-4 col-sm-12 col-md-12  mobile-app-col">
                        <div class="services-icon"><img src="assets/img/services/devops/azure.png" /></div>
                    </div>
                    <div class="col-lg-4 col-sm-12 col-md-12  mobile-app-col">
                        <div class="services-icon"><img src="assets/img/services/devops/amazon-web-services.jpg" />
                        </div>
                    </div>
                </div>
