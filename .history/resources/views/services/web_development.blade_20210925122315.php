...
@section('web-devolopment-contain')
    ...
    $image1 = 'assets/img/services/web/Mokup – 10.png';
    $image2 = 'assets/img/services/web/Mokup – 9.png';
    $image3 = 'assets/img/services/web/Mokup – 12.png';
    $image4 = 'assets/img/services/web/Mokup – 18.png';
