...
@section('homepage-contain')
    ...
    $metacontent = 'IndiaNIC is the best offshore IT company since 2020 that offers offshore software development services for web and mobile apps using trending technologies.';
