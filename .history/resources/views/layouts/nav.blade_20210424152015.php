        ...
        <header id="header" class="fixed-top">
            <div class="container">
                ...
                <nav class="main-nav float-right d-none d-lg-block">
                    <ul>
                        <li class="active"><a href="/" class="menu-c">Home</a></li>
                                ...
                                <table>
                                    <ul>
                                        <tr>
                                            ...
                                            <td>
                                                <li><i class="fa fa-database"><img src="https://img.icons8.com/ios-glyphs/10/4a90e2/devops.png"/></i><strong><span class="sub-dropdown-title"><a href="/database_development" class="link">DevOps </a></span></strong>
                                                </li>
                                            </td>
                                        </tr>
                                    </ul>
