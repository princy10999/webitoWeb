                                ...
                                <table>
                                    <ul>
                                        <tr>
                                            ...
                                            <td>
                                                <li><i class="fa fa-database"></i><strong><span class="sub-dropdown-title"><a href="/database_development" class="link">DevOps </a></span></strong>
                                                </li>
                                            </td>
                                        </tr>
                                    </ul>
                                    <tr>
                                        ...
                                        <td>
                                            <ul class="sub-dropdown-content">
                                                ...
                                                <li><a href="#" class="link">Google Cloude</a></li>
                                            </ul>
                                        </td>
                                    </tr>
                                </table>
