...
<body>
    ...
    <nav class="navbar nav-styles">
        <div class="brand-and-icon">
            <a href="index.html" class="navbar-brand"><img src="{{ url('../../../assets/img/index/logo/logo.png') }}" class="main-logo"
                    alt="Image" /></a>
        ...
        <div class="navbar-collapse">
            <ul class="navbar-nav">
                ...
                <li><a href="#" class="mai-nav-contact-desc-hide">Contact Us</a></li>


            </ul>
        </div>
        <div class="desc-contact-div">
            <a class="desc-contact-btn" href="#" role="button">CONTACT US</a></a>
            <a class="dark-mode-btn" onclick="darkmode()"><i class="far fa-moon fa-lg"></i><i class="fa fa-moon-o"></i>
            </a>
