        ...
        <header id="header" class="fixed-top">
            <div class="container">
                ...
                <nav class="main-nav float-right d-none d-lg-block">
                    <ul>
                        <li route::get('/mobileapp_development' , 'App\Http\Controllers\pagesController@mobileapp_development');><a href="/" class="menu-c">Home</a></li>
                                ...
                                <table>
                                    <ul>
                                        <tr>
                                            ...
                                            <td>
                                                <li><i class="fa fa-database"></i><strong><span class="sub-dropdown-title"><a href="/database_development" class="link">Database</a></span></strong>
                                                </li>
                                            </td>
                                        </tr>
                                    </ul>
