        ...
        <header id="header" class="fixed-top">
            <div class="container">
                ...
                <nav class="main-nav float-right d-none d-lg-block">
                    <ul>
                        <li class="active"><a href="/#intro" class="menu-c">Home</a></li>
                        <li ><a href="/#about" class="menu-c">About Us</a></li>
                        ...
                        <li><a href="/#portfolio" class="menu-c">Portfolio</a></li>
                        <li><a href="/#team" class="menu-c">Team</a></li>
