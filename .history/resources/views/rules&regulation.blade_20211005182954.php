...
@section('homepage-contain')
    ...
    <div class="color">
        ...
        <?php
        $id_pass = '';
        $box1title = 'OFFICE TIMING:';
        $desc1 = 'The Companys working hours are Monday to Saturday, from 9.30 am to 6.30 pm. You
                        are entitled to 45 minutes of lunch break every day.
                        Lunch timing is 1:00 p.m. to 1:45 p.m. And 10 Minutes tea Break in evening ';
