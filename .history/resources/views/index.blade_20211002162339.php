    ...
    <section id="intro" class="clearfix">
        <div class="container">
            ...
            <div class="intro-content right">
                <img src="/assets/img/index/illustration/Team work-amico.png" alt="Webito Infotech"
    ...
    <main id="main">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-5 wow bounceInUp" data-wow-delay="0.2s" data-wow-duration="1.4s">
                        <div class="box">
                            <div class="icon"><i class="fa fa-gamepad"
                                    style="color: #4680ff; font-size: 50px;"></i>
                            </div>
        ...
        <section id="why-us" class="wow fadeIn">
            ...
            <div class="container-fluid">
                <div class="row counters">
                    ...
                    <div class="col-lg-3 col-6 text-center">
                        <h1><span class="counter">37</span></h1>
                        <p>Projects</p>
                    </div>
                    <div class="col-lg-3 col-6 text-center">
                        <h1><span class="counter">3720</span></h1>
        ...
        <section id="clients" class="section-bg">
            ...
            <div class="container">
                ...
                <div class="section-header">
                    <h3 class="h-paddingbottom30" style="color: #283d50 !important">Our Clients</h3>
                </div>
                <div class="customer-logos slider">
                    <a href="http://tiifafilmcity.in/">
                        <div class="slide"><img src="assets/img/index/clients/13.png" alt="Tiifa Filmcity">
                        </div>
                    </a>
                    <a href="https://aaravstarexports.com/">
                        <div class="slide"><img src="assets/img/index/clients/10.png" alt="Aaravstar Exports">
                        </div>
                    </a>
                    <a href="https://rosyimitation.com/">
                        <div class="slide"><img src="assets/img/index/clients/6.png" alt="Rosy Imitation">
                        </div>
                    </a>
                    <a href="http://vmjewel.com/">
                        <div class="slide"><img src="assets/img/index/clients/17.png" alt="Vm Jewels">
                        </div>
                    </a>
                    <a href="https://xsourceinterio.com/">
                        <div class="slide"><img src="assets/img/index/clients/5.png" alt="Xsource Interio">
                        </div>
                    </a>
                    <a href="https://www.livecake.in/">
                        <div class="slide"><img src="assets/img/index/clients/14.png" alt="Cake Factory"></div>
                    </a>
                    <a href="">
                        <div class="slide"><img src="assets/img/index/clients/2.png" alt="JKR">
                        </div>
                    </a>
                    <a href="">
                        <div class="slide"><img src="assets/img/index/clients/3.png" alt="Zalak Doors">
                        </div>
                    </a>
                    <a href="https://www.ldrp.ac.in/">
                        <div class="slide"><img src="assets/img/index/clients/1.png" alt="LDRP">
                        </div>
                    </a>
                    <a href="">
                        <div class="slide"><img src="assets/img/index/clients/8.png" alt="Leafberry Herbal">
                        </div>
                    </a>
                    <a href="https://heavendesigns.in/">
                        <div class="slide"><img src="assets/img/index/clients/7.png" alt="Solar Heaven">
                        </div>
                    </a>
                    <a href="https://www.goinfa.com/">
                        <div class="slide"><img src="assets/img/index/clients/11.png" alt="Go infa"></div>
                    </a>
                    <a href="https://banweryfashion.com/">
                        <div class="slide"><img src="assets/img/index/clients/4.png" alt="Banwery"></div>
                    </a>
                    <a href="http://t3developers.com/">
                        <div class="slide"><img src="assets/img/index/clients/12.png" alt="T3 Developers"></div>
                    </a>
                    <a href="https://princejewellery.in/">
                        <div class="slide"><img src="assets/img/index/clients/9.png" alt="Prince Jewellery"></div>
                    </a>
                    <a href="">
                        <div class="slide"><img src="assets/img/index/clients/15.png" alt="Coptic Meet">
                        </div>
                    </a>
