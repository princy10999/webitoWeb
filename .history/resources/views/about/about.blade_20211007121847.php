...
@section('aboutcontent')
    ...
    <section>
        <div class="container space">
            <h2 class="text-center">WHY DO PEOPLE CHOOSE US?</h2>
    ...
    $image = 'assets/img/about/how-we-start.jpg';
    ?>
    ...
    $desc1 = 'The company grew leaps and bounds with over 30 (and counting…) successful customized web applications and solutions empowering businesses around the world to harness the force of technology to enrich human lives and increase business efficiency.
            We take immense pleasure to say that 70% of our business comes from existing clients. Our clients choose us time and time again as they trust us to deliver effective solutions that meet their specific business requirements. Needless to say, transparency in our business deal has been our greatest strength.';
    $image = 'assets/img/about/how-we-grow.png';
    ...
    <section class="discovery-process-section" style="margin: 80px 0 120px 0">
        <div class="container">
            <h2 class="mrg-b">We Simplify Software Development Process</h2>
            <div class="row">
                <div class="col-12 col-md-6 col-lg-3 process-block">
                    <div class="process-box">
                        <div class="icon-box"><img src="/assets/img/about/discover.png" alt=""></div>
                        <h3>Discover</h3>
                ...
                <div class="col-12 col-md-6 col-lg-3 process-block">
                    <div class="process-box">
                        <div class="icon-box"><img src="/assets/img/about/design.png" alt=""></div>
                        <h3>Design</h3>
                ...
                <div class="col-12 col-md-6 col-lg-3 process-block">
                    <div class="process-box">
                        <div class="icon-box"><img src="/assets/img/about/build.png" alt=""></div>
                        <h3>Build</h3>
                ...
                <div class="col-12 col-md-6 col-lg-3 process-block">
                    <div class="process-box">
                        <div class="icon-box"><img src="/assets/img/about/deliver.png" alt=""></div>
                        <h3>Deliver</h3>
    ...
    $image = 'assets/img/about/our-mission.jpg';
    ?>
    ...
    $image = 'assets/img/about/vision2.jpg';
    ?>
            ...
            <div class="row">
                <div class="col-12 col-md-8 col-lg-7">
                    <div class="contact-section-box">
                        ...
                        <div class="button-box"><a href="" class="link-button"> Our CEO's Message in Full </a></div>
                    </div>
                </div>
            </div>
        </div>
