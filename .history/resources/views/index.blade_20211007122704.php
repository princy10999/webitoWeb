...
@section('homepage-contain')
    ...
    $metacontent = 'Webito Infotech is the best IT company since 2020 that offers offshore software development services for web and mobile apps using trending technologies.';
