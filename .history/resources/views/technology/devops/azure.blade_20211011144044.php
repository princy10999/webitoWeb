...
@section('mobile-contain')
    ...
    $metacontent = 'IndiaNIC is the best Microsoft Azure Cloud services & solutions company in USA to hire expert Azure developers to build web apps via a cloud-based platform.';
