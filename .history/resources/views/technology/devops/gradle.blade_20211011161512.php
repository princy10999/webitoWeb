...
@section('mobile-contain')
    ...
    $slide4desc = 'We at IndiaNIC offer flexible engagement models to hire Gradle developers as per business needs leveraging all-in-one Gradle build automation testing services. Hire Gradle testers in India and USA to build high performing applications at the best rates. We implement best practices of Gradle implementation to help fulfill your strategic business objectives.';
