...
@section('mobile-contain')
    ...
    $desc = 'Hire Google Cloud developers from IndiaNIC to develop, integrate and manage highly scalable, robust applications on Google Cloud. IndiaNIC is a leading Google Cloud development company offering end-to-end Google Cloud development services from Google Cloud Platform (GCP) consultation, system integration and implementation to Google Cloud development for all businesses.';
