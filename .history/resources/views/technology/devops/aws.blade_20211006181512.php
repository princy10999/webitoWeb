...
@section('mobile-contain')
    ...
    $desc = 'IndiaNIC is a leading DevOps consultation and AWS cloud solutions development company that offers affordable, reliable, flexible and scalable cloud solutions. Hire AWS developers who have years of experience to provide AWS cloud application development, system implementation, integration and consultation services surrounding AWS cloud ecosystem for enhanced business solutions.';
