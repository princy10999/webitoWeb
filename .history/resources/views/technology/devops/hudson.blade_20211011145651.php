...
@section('mobile-contain')
    ...
    $metacontent = 'content="Hire Hudson Developers from a top DevOps services providing company, who have expertise in top automation tools for flawless web & mobile app development."';
