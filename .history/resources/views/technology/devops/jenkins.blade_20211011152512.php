...
@section('mobile-contain')
    ...
    {{-- Offer-Section Start --}}
    <?php
    $title = 'Strategic Application Testing';
    $subtitle = 'WHAT WE DO';

    $slide1title = 'We plan an automation process that depends on the app development stage, infrastructure analysis, and understanding challenges.';
