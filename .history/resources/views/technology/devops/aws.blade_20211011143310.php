...
@section('mobile-contain')
    ...
    $metacontent = 'IndiaNIC is a leading DevOps Consultation and AWS Cloud Solutions Development Company that offers scalable cloud solutions. Hire certified AWS architects!';
