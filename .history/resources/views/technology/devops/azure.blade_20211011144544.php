...
@section('mobile-contain')
    ...
    $slide2desc = 'To ensure quality deliverables, our QA ( Quality Analysts) perform dedicated and stringent quality checks at every level of Microsoft Azure development. Azure cloud computing & Azure development services at IndiaNIC include code review from Azure experts to ensure a complete, robust and flexible cloud platform to manage your business applications.';
