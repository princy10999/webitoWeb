...
@section('mobile-contain')
    ...
    $metacontent = 'IndiaNIC is a leading Google Cloud services providing company that offers facility to hire Google Cloud architects along with expert DevOps consultation.';
