...
@section('mobile-contain')
    ...
    $slide1desc = 'To ensure quality deliverables, our QA ( Quality Analysts) perform dedicated and stringent quality checks at every level of the Appium automation testing process. Hire Appium testers who work coordination with iOS app development and Android app development to enforce seamless mobile app testing.';
