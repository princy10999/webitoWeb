...
@section('mobile-contain')
    ...
    $desc = 'Hire expert Jenkins developers from IndiaNIC to start defining and executing tests on-the-go, from development stages to production. In the agile software development environment, Continuous Integration enhances overall process and software quality. Our Jenkin CI services will help to speed up the error-free development process while avoiding last-hour chaos.';
