...
@section('mobile-contain')
    ...
    $slide4desc = 'We at IndiaNIC offer flexible engagement models to hire Appium developers as per business needs leveraging all-in-one Appium automation testing services. Hire Appium testers in India and USA to build high performing applications at the best rates. We implement best practices of Appium implementation to help fulfill your strategic business objectives.';
