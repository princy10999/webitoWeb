...
@section('mobile-contain')
    ...
    $slide4desc = 'We at IndiaNIC offer flexible engagement models to hire Selenium developers as per business needs leveraging all-in-one Selenium automation testing services. Hire Selenium testers in India and USA to build high performing applications at the best rates. We implement best practices of Selenium implementation to help fulfill your strategic business objectives.';
