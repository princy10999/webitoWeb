...
@section('mobile-contain')
    ...
    $slide1desc = 'Hire Gradle automation testers from IndiaNIC who develop and run robust scripts with faster execution to measure database performance. Our Gradle developers are well versed in working across all the operating systems and devices with proficiency in C++, Java, JavaScript, Kotlin, Scala, Spring, CI automation tools like Hudson, Jenkins, etc.';
