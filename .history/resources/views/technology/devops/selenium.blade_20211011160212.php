...
@section('mobile-contain')
    ...
    $desc = 'IndiaNIC is a leading Selenium automation app testing company delivering quality websites and applications. We are a one-stop-shop for end-to-end Selenium testing services that include robust script development, test automation framework set up for web, mobile, & desktop applications, maintenance, and test automation training.IndiaNIC is a leading Selenium automation app testing company delivering quality websites and applications. We are a one-stop-shop for end-to-end Selenium testing services that include robust script development, test automation framework set up for web, mobile, & desktop applications, maintenance, and test automation training.';
