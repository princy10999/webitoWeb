...
@section('mobile-contain')
    ...
    $slide7title = 'Java Migration Services';
    $slide7desc = 'Switch your existing web application to Java framework without compromising on data and security.';

    $slide8title = 'Java Migration Services';
    $slide8desc = 'Switch your existing web application to Java framework without compromising on data and security.';

    $slide9title = 'Java Migration Services';
    $slide9desc = 'Switch your existing web application to Java framework without compromising on data and security.';
    ?>
