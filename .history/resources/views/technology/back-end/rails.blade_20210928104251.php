...
@section('mobile-contain')
    ...
    $desc = 'We are simply the best Ruby on Rails (RoR) web development company in India for using an open-source Rails framework to develop dynamic websites & applications. Hire RoR developers from IndiaNIC to avail end-to-end Ruby on Rails web development services at affordable prices.';
