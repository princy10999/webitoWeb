...
@section('mobile-contain')
    ...
    $desc = 'We are simply the best Ruby on Rails (RoR) web development company in India & USA for using an open-source Rails framework to develop dynamic websites & applications. Hire RoR developers from IndiaNIC to avail end-to-end Ruby on Rails web development services at affordable prices.';
    ...
    $slide4desc = 'We empower businesses to achieve and reach their full potential and goals through end-to-end RoR development services. Hire dedicated RoR developers from IndiaNIC having huge experience under the sleeves to perform flawless programming using Ruby. RoR programmers at IndiaNIC leverage benefits of Rails framework to deliver dynamic, robust and scalable websites and applications.';
