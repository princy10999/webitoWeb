...
@section('mobile-contain')
    ...
    $desc = 'We are at the forefront in providing expert Vue.js app development services to build single-page apps (SPAs), complex and progressive web apps (PWAs). Hire Vue.js developers from IndiaNIC, a top Vue.js development company in India & USA, to grow your business with best-in-class Vue.js solutions with intuitive and appealing UI for web apps.';
