...
@section('mobile-contain')
    ...
    $slide2desc = 'To ensure quality deliverables, our QAs (Quality Analysts) perform dedicated and stringent quality checks at every level of WPF app development. Hire WPF developers from IndiaNIC, who also perform code review to ensure that the Windows Presentation Foundation (WPF) app we deliver is fully functional, compatible, flawless, bug-free and user-friendly.';
    ...
    $slide3desc = 'Hire dedicated WPF developers from IndiaNIC, who will deliver stunning windows applications with appealing UI by integrating UI elements like typography, 2D/3D rendering, vector graphics, pre-rendered media, fixed and adaptive documents, runtime animation, etc. all at one place.';
