...
@section('mobile-contain')
    ...
    $slide4desc = 'Hire dedicated TypeScript developers from a leading Web development company that offers the best TypeScript development services for years. We at IndiaNIC, a leasing TypeScript development company, offer flexible engagement models to hire dedicated TypeScript developers as per business needs leveraging end-to-end TypeScript development services.';
