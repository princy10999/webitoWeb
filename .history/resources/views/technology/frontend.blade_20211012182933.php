...
@section('fronend-contain')
    ...
    $metacontent = 'Webito Infotech is the best Website Development Company Surat, India. We offer professional web development services. Call us at +91 8690586753 /
                        +91 9724259460 for any web development solutions.';
    ...
    $box6paragraph = 'Crafting apps for iPhone, iPad, Apple Watch, Apple TV, etc. with AI & ML integration and more, keeping users at the core.';
    ?>
    ...
    $image = 'assets/img/technologies/BanweryFashion.webp';
    ?>
