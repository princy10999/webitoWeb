...
@section('mobile-contain')
    ...
    $slide4desc = 'Hire dedicated Umbraco developers from a leading Umbraco website development company that offers to integrate CMS with the utmost flexibility. We at IndiaNIC offer flexible engagement models to hire dedicated Umbraco developers as per business needs leveraging full-fledged Umbraco development services.';
    ...
    $slide4title = 'Hire Umbraco developers to foster migration of PHP, ASP, ASP.NET and other CMS systems to Umbraco powered websites or CMS.';
