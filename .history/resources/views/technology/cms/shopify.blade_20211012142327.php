...
@section('mobile-contain')
    ...
    $slide1desc = 'IndiaNIC is a leading Shopify eCommerce web development company supports you at every stage of developing an online store while offering services like customized website design and Shopify theme development. As a certified Shopify Plus Partner, we also assist our clients in switching their existing online store to Shopify through quality migration services.';
