...
@section('mobile-contain')
    ...
    $metacontent = 'IndiaNIC is a leading Drupal web development company that offers a complete range of Drupal development services for all businesses. Hire Drupal developers.';
