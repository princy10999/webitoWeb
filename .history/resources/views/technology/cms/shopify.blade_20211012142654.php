...
@section('mobile-contain')
    ...
    $slide2desc = 'Being a leading Shopify website development company, we put stringent quality checks at every level of our eCommerce web store development services. Hire Shopify experts from IndiaNIC who make sure to utilize all of Shopify leading features such as professionals themes, advanced functionality and complete CMS to deliver a highly secure and user-friendly eCommerce website.';
    ...
    $slide4desc = 'You can hire Shopify developers from IndiaNIC through flexible engagement models deployed for working exclusively on your online eCommerce web store development. Our holistic approach and agile development method will make you aware of the latest online marketing trends and Shopify tools while creating bespoke eCommerce solutions for your business.';
