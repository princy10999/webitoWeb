...
@section('mobile-contain')
    <!-- Meta Tag  -->
    <?php
    $seotitle = 'Magento eCommerce Web Development';
    $metacontent = 'Webito Infotech is a leading Magento eCommerce store development company in India & USA, that provides eCommerce development services designed for every online business irrespective of size, value, and model to provide high customizability at low costs.';
