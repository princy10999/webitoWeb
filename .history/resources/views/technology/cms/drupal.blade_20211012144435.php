...
@section('mobile-contain')
    ...
    $desc = 'As a leading Drupal Website Development Company in India, IndiaNIC helps you benefit from this enterprise-ready content management framework with extensive API support leveraging a full range of Drupal web development services by expert Drupal web developers.';
