...
@section('devops-contain')
    ...
    $box6title = '<img src="https://img.icons8.com/ios-filled/50/4a90e2/selenium-test-automation.png"/>';
    $box6paragraph = 'Software testers at IndiaNIC are experienced with this tool to foster testing automation for mobile apps to deliver with superior quality.';
    ?>
