            ...
            <div _ngcontent-c3="" class="we-work-slider slick-initialized slick-slider" role="toolbar"><span
                ...
                < !---->
                    <div aria-live="polite" class="slick-list draggable main-sec">
                        <div class="slick-track slide-sec" style="opacity: 1; width: 6660px; left: -1110px;"
                            role="listbox">
                    ...
                    <ul class="slick-dots" style="" role="tablist">
                        ...
                        <li aria-hidden="true" role="presentation" aria-selected="false" aria-controls="navigation03"
                            id="slick-slide03"><button type="button" data-role="none" role="button"
                                aria-required="false" tabindex="0">4</button></li>
                    </ul>
            </div>
        </div>
    </div>
...
<div class="slideshow-container">
    ...
    <div class="mySlides fade">
        ...
        <img src="https://d1i2cp4a5c819e.cloudfront.net/wp-content/uploads/2020/02/approch-slide-img-1.svg" alt="1"
            style="width:100%">
        <div class="text">Caption Text</div>
    </div>
    ...
    <div class="mySlides fade">
        ...
        <img src="https://d1i2cp4a5c819e.cloudfront.net/wp-content/uploads/2020/02/approch-slide-img-4.svg" alt="2"
            style="width:100%">
        <div class="text">Caption Two</div>
    </div>
    ...
    <div class="mySlides fade">
        ...
        <img src="https://d1i2cp4a5c819e.cloudfront.net/wp-content/uploads/2020/02/approch-slide-img-1.svgg" alt="3"
            style="width:100%">
        <div class="text">Caption Three</div>
    </div>
