                                ...
                                <div _ngcontent-c3="" class="col-md-6 col-sm-12 flex-sec">
                                    <div _ngcontent-c3="" class="work-info">
                                        ...
                                        <p _ngcontent-c3="">Using a single code using Google’s Flutter SDK,
                                            ...
                                            to life the expectations you aspire for them. </p>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<br>
<span class="slick-arrow next-arrow" style=""></span>
<ul class="slick-dots" style="" role="tablist">
    <li class="slick-active" aria-hidden="false" role="presentation" aria-selected="true" aria-controls="navigation00"
        id="slick-slide00"><button type="button" data-role="none" role="button" aria-required="false"
