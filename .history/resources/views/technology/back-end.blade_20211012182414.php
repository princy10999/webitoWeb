...
@section('backend-contain')
    ...
    $desc = 'Backend is not the only reason why users join your app, but a poor backend is definitely the reason to drive them away. Webito holds experience to take on backend challenges for any scale and complexity, using the right
                            technologies to build an architecture without a single point failure. Get slicker and faster app performance at all times with 100% guarantee!';
    ?>
    ...
    $image = 'assets/img/technologies/VMjewels.webp';
    ?>
