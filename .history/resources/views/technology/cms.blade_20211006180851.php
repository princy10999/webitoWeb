...
@section('cms-contain')
    ...
    $helpparagraph1 = 'Webito Infotech is an award winning CMS development company in India and USA helping startups, enterprises and all other global businesses with bespoke CMS solutions based on their project needs.';
    ...
    $icon5 = 'https://img.icons8.com/ios/50/4a90e2/drupal.png';
