...
@section('cms-contain')
    ...
    $box5paragraph = 'IndiaNIC helps you benefit from this enterprise-ready content management framework with extensive API support to incorporate the latest features.';
    ?>
