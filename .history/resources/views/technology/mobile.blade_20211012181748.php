...
@section('mobile-contain')
    ...
    $desc = 'Webito helps to conceptualize, design, develop, and implement mobile app solutions for enterprises and
            startups with over 22+ years of experience.';
    ?>
    ...
    $box1paragraph = 'Crafting apps for iPhone, iPad, Apple Watch, Apple TV, etc.
    ...
    $box2paragraph = 'Our dev team helps you craft native Android apps for Smartphones,
            Tablets, Android Wear, and Android TV from the scratch.';
    ?>
    ...
    $box3paragraph = 'Delivering affordable yet fast, powerful, and high
            performing cross-platform apps with native look and feel.';
    ?>
    ...
    $box4paragraph = 'Crafting apps for iPhone, iPad, Apple Watch, Apple TV, etc.
            with AI & ML integration and more, keeping users at the core.';
    ?>
    ...
    $box5paragraph = 'Crafting fast and interactive hybrid applications that
            work perfectly on web, mobile and desktop devices using Ionic.';
    ?>
    ...
    $image = 'assets/img/technologies/RosyImitation.webp';
    ?>
