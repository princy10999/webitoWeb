...
@section('mobile-contain')
    ...
    $desc = 'IndiaNIC is a leading Amazon DynamoDB development company to develop and deliver robust database support systems for building applications across various industries. Leveraging NoSQL database services of popular Amazon DynamoDB, we build faster, flexible and highly functional mobile applications leveraging expert DynamoDB development services. With DynamoDB, we create database tables that can store and retrieve any amount of data, and serve any level of request traffic.';
