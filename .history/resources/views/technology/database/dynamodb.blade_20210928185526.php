...
@section('mobile-contain')
    ...
    $slide4desc = 'We at IndiaNIC, a leading Amazon DynamoDB development company, offer flexible engagement models to hire DynamoDB developers as per business needs leveraging full-fledged DynamoDB development services. Contact us now to hire DynamoDB developers in India and USA to build high performing web and mobile applications at the best rates.';
