...
@section('mobile-contain')
    ...
    $slide4desc = 'We at IndiaNIC offer flexible engagement models to hire MongoDB developers as per business needs leveraging full-fledged MongoDB development services. Contact us now to hire MongoDB developers in India to build a high performing web and mobile applications at the best rates.';
