...
@section('mobile-contain')
    ...
    $slide2desc = 'To ensure quality deliverables, our QA ( Quality Analysts) perform dedicated and stringent quality checks at every level of PostgreSQL development. Hire PostgreSQL development services from IndiaNIC which include code review from PostgreSQL experts to ensure that the end product is fast, functional and secure with amazing user experience.';
