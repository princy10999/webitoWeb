...
@section('mobile-contain')
    ...
    $desc = 'A leading MySQL applications development company having over two decades of experience in delivering high-performance web & mobile apps. Hire MySQL developers from IndiaNIC who develop superior dynamic database-driven business applications leveraging Java and PHP.';
    ...
    $slide2desc = 'To ensure quality deliverables, our QA ( Quality Analysts) perform dedicated and stringent quality checks at every level of MySQL development. Hire affordable PHP MySQL development services from IndiaNIC, a leading PHP MySQL app development company, that include code review from MySQL experts to ensure that the end product is fully functional, secure, flawless, and user-friendly.';
