...
@section('mobile-contain')
    ...
    $desc = 'We are a trusted Redis database development company delivering beautiful back-end applications from idea to consumer. Hire Redis developers from IndiaNIC for top quality Redis Database development services, who will take your business applications to the next level given the speed and performance of the fastest open-source database.';
    ...
    $slide1desc = 'We are a leading Redis database development company having full-stack database architects to provide end-to-end Redis database development services, from the design face all the way to the implementation. Redis developers at IndiaNIC are well versed in programming languages like C, C#, C++, Clojure, Crystal, D, Dart, Elixir, Erlang, Fancy, Go, Haskell, Haxe, Java, JavaScript, Lisp, Lua, MatLab, Objective-C, OCaml, Perl, PHP, Prolog, Pure Data, Python, R, Rebol, Ruby, Rust, Scala, Scheme, Smalltalk, Tcl.';
    ...
    $slide2desc = 'To ensure quality deliverables, our QA ( Quality Analysts) perform dedicated and stringent quality checks at every level of Redis database development. Hire Redis database development services from IndiaNIC that include code review from back-end system experts to ensure that the end product is fast, functional and secure.';
    ...
    $slide2desc = 'Hire MongoDB developers from IndiaNIC to build dynamic web & mobile applications using MongoDB as the data backend.';
