                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6 col-lg-4">
                                                                        ...
                                                                        <select data-ref="careers_applied_position"
                                                                            ...
                                                                            <option relatedurl="#" value="41653">Android
                                                                                with Flutter Developer
                                                                            </option>
                                                                            <option relatedurl="#" value="29840">Business
                                                                                Analyst</option>
                                                                            <option relatedurl="3" value="43652">Dot Net MVC
                                                                                Developer</option>
                                                                            <option relatedurl="#" value="43653">Full Stack
                                                                                Developer</option>
                                                                            <option relatedurl="#" value="41654">iOS with
                                                                                Flutter Developer
                                                                            </option>
                                                                            <option relatedurl="#" value="29210">Laravel
                                                                                Developer</option>
                                                                            <option relatedurl="#" value="29654">Magento
                                                                                Developer</option>
                                                                            <option relatedurl="#" value="43654"
                                                                                selected="">Mern Stack
                                                                                Developer</option>
                                                                            <option relatedurl="#" value="43650">React
                                                                                Native Developer
                                                                            </option>
                                                                            <option relatedurl="#" value="29960">ReactJs
                                                                                Developer</option>
                                                                            <option relatedurl="#" value="43651">Sr. Laravel
                                                                                Developer</option>
                                                                            <option relatedurl="#" value="43649">Sr. QA
                                                                                Engineer</option>
                                                                            <option relatedurl="#" value="41652">WordPress
                                                                                Developer</option>
                                                                        </select>
                                                                    </div>
                                                                </div>
