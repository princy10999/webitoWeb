                                    ...
                                    <form action="{{ route('form.store2') }}" method="POST" class="apply-now-form">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-lg-4">
                                                ...
                                                {{-- <button type="submit" id="btn_apply12">submit</button> --}}
                                                {{-- <button type="submit" name="" class="btn gradient-btn"
                                                        id="btn_apply12">APPLY
                                                        <span class="cd-modal-bg"></span></button> --}}
                                                {{-- <script>
                                                        function pageRedirectServices() {
                                                            // alert("hello");
                                                            // console.log("jsdsjds");


                                                            var qr_type = $('#dynamic_select').find(":selected").text();
                                                            alert(qr_type);
                                                            console.log(qr_type);
                                                            $.ajaxSetup({
                                                                headers: {
                                                ...
                                                {{-- <script>
                                                        $("#btn_apply12").click(function() {

                                                            // var android = $("#dynamic_select:selected").val();
                                                            // var android11 = $("#dynamic_select:selected").text();
                                                            var conceptText = $('#dynamic_select').find(":selected").text();
                                                            $('#android').val(conceptText);
                                                            // var conceptVal = $('#dynamic_select').find(":selected").val();
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-lg-4">
                                                    <input data-ref="careers_present_salary" type="text"
                                                        ...
                                                        placeholder="" required><label class="required">Present
                                                        Salary</label>
                                                    <span class="focus-border"></span>
                                                </div>
                                        ...
                                        <div class="skill d-inline-block mr-top-80 w-100">
                                            ...
                                            <div class="colm-one">
                                                <textarea data-ref="careers_technical_skills" rows="1" cols="1"
                                                    name="careers_technical_skills" class="message effect-1"
                                                    required></textarea><label class="required">Your
                                                    Technical
