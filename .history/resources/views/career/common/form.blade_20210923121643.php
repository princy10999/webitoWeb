                    ...
                    <div class="wpb_wrapper">
                        ...
                        <div id="mpc_textblock-9661497b8fa3651" class="mpc-textblock mpc-inited" style="opacity: 1;">
                            <div id="apply-form" class="cd-section thanks-popup fixed-popup">
                                <form id="submitCareersForm" class="apply-now-form" action="" method="POST"
                                    enctype="multipart/form-data">
                                    <input type="hidden" id="inic_careers_nonce" name="inic_careers_nonce"
                                        value="93f8517dde"><input type="hidden" name="_wp_http_referer"
                                    ...
                                    <div class="container">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-lg-4">
                                                ...
                                                <select data-ref="careers_applied_position" class="select"
                                                    ...
                                                    <option relatedurl="#" value="1">Android
                                                        with Flutter Developer
                                                    </option>
                                                    <option relatedurl="#" value="2">Business
                                                        Analyst</option>
                                                    <option relatedurl="3" value="3">Dot Net MVC
                                                        Developer</option>
                                                    <option relatedurl="#" value="4">Full Stack
                                                        Developer</option>
                                                    <option relatedurl="#" value="5">iOS with
                                                        Flutter Developer
                                                    </option>
                                                    <option relatedurl="#" value="6">Laravel
                                                        Developer</option>
                                                    <option relatedurl="#" value="7">Magento
                                                        Developer</option>
                                                    <option relatedurl="#" value="8" selected="">Mern Stack
                                                        Developer</option>
                                                    <option relatedurl="#" value="9">React
                                                        Native Developer
                                                    </option>
                                                    <option relatedurl="#" value="10">ReactJs
                                                        Developer</option>
                                                    <option relatedurl="#" value="11">Sr. Laravel
                                                        Developer</option>
                                                    <option relatedurl="#" value="12">Sr. QA
                                                        Engineer</option>
                                                    <option relatedurl="#" value="13">WordPress
                                                        Developer</option>
                                                </select>
                                                        ...
                                                        if (value == '1') {
                                                            $("#careers-detail-box")
                                                                .html("<div class="
                                                                    ...
                                                                    li > Must have 1.5 Yrs experience in NodeJS & amp; React development. < /li> <
                                                                    li > Must be passionate about writing clean, efficient,
                                                                    and maintainable code.Self - starter with ability cope with sharp learning curves. < /li> <
                                                                    li > Excellent teamwork skills, Good Communication skill <
                                                                    /li> <
                                                                    li > Skills: Primary: NodeJS, MySql, MongoDB, Angular 4 + ,
                                                                    ES6, Express Js, React JS & amp; React Native < /li> <
                                                                    /ul> <
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 col-lg-4 mb-5">
                                                    <input data-ref="careers_fullname" type="text"
                                                        ...
                                                        placeholder=""><label class="required">Name</label>
                                                ...
                                                <div class="col-md-6 col-lg-4 mb-5">
                                                    <input data-ref="careers_current_location" type="text"
                                                        ...
                                                        placeholder=""><label class="required">Current
                                                        Location</label>
                                                    <span class="focus-border"></span>
                                                </div>
                                                ...
                                                <div class="col-md-6 col-lg-4 mb-5">
                                                    <input data-ref="careers_contact_number" type="text"
                                                        ...
                                                        placeholder=""><label class="required">Contact
                                                        Number</label>
                                                    <span class="focus-border"></span>
                                                </div>
                                                ...
                                                <div class="col-md-6 col-lg-4 mb-5">
                                                    <input data-ref="careers_contact_email" type="email"
                                                        ...
                                                        placeholder=""><label class="required">Contact Email
                                                    </label>
                                                    <span class="focus-border"></span>
                                                </div>
                                            ...
                                            <table class="apply-table" align="left" cellpadding="0" cellspacing="0"
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="fnt"><input
                                                                data-ref="careers_educations_ssc_percentage" type="text"
                                                                class="full-name"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="fnt"><input
                                                                data-ref="careers_educations_hsc_percentage" type="text"
                                                                class="full-name"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-lg-4">
                                                    <input data-ref="careers_present_salary" type="text"
                                                        ...
                                                        placeholder=""><label class="required">Present
                                                        Salary</label>
                                                    <span class="focus-border"></span>
                                                </div>
                                        ...
                                        <div class="more-about-you d-inline-block w-100 mr-top-80">
                                            ...
                                            <div class="colm-one mr-top">
                                                <textarea rows="1" cols="1" name="careers_coworker_describe_as_person"
                                            ...
                                            <div class="colm-one mr-top">
                                                <textarea data-ref="careers_reason_for_looking_job" rows="1" cols="1"
                                            ...
                                            <div class="colm-one mr-top">
                                                <textarea rows="1" cols="1" name="careers_ready_to_work_in_night_shift"
