                                            ...
                                            <div class="col-md-6 col-lg-4">
                                                ...
                                                <select data-ref="careers_applied_position" class="select"
                                                    ...
                                                    <option relatedurl="3" value="3">Dot Net MVC
                                                        Developer</option>
                                                    <option relatedurl="#" value="Full Stack Developer">Full Stack
                                                        Developer</option>
                                                    ...
                                                    <option relatedurl="#" value="7">Magento
                                                        Developer</option>
                                                    <option relatedurl="#" value="8">Mern Stack
                                                        Developer</option>
                                                ...
                                                <script>
                                                    $(function() {
                                                        ...
                                                        with Flutter Developer</h1>
                                                            ...
                                                            } else if (value == 'Full Stack Developer') {
                                                                $("#careers-detail-box")
                                                                    .html(`<div class="detail-title">
...
<script>
    $(document).ready(function() {
        ...
        if (positionId != 1) {
            ...
            } else if (positionId == 'Full Stack Developer') {
                $("#careers-detail-box")
                    .html(`<div class="detail-title">
                                                                    <h1>Full Stack Developer</h1>
                                                                    <p>Surat</p>
