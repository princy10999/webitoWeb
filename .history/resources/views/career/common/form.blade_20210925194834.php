                        ...
                        <div id="mpc_textblock-9661497b8fa3651" class="mpc-textblock mpc-inited" style="opacity: 1;">
                            <div id="apply-form" class="cd-section thanks-popup fixed-popup">
                                ...
                                <div class="container">
                                    ...
                                    @endif
                                    <form action="{{ route('form.store2') }}" method="POST" class="apply-now-form">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-6 col-lg-4">
                                                ...
                                                <select data-ref="careers_applied_position" class="select"
                                                    ...
                                                    value="">
                                                    {{-- <?php echo $positionId; ?>"> --}}
                                                    <option relatedurl=" #" value="Android with Flutter Developer">
                                                        Android
                                                        with Flutter Developer
                                                    </option>
                                                    <option relatedurl="#" value="Business Analyst">Business
                                                        Analyst</option>
                                                    <option relatedurl="3" value="Dot Net MVC Developer">Dot Net MVC
                                                        Developer</option>
                                                    <option relatedurl="#" value="Full Stack Developer">Full Stack
                                                        Developer</option>
                                                    <option relatedurl="#" value="iOS with Flutter Developer">iOS
                                                        with
                                                        Flutter Developer
                                                    </option>
                                                    <option relatedurl="#" value="Laravel Developer">Laravel
                                                        Developer</option>
                                                    <option relatedurl="#" value="Magento Developer">Magento
                                                        Developer</option>
                                                    <option relatedurl="#" value="Mern Stack Developer">Mern Stack
                                                        Developer</option>
                                                    <option relatedurl="#" value="React Native Developer">React
                                                        Native Developer
                                                    </option>
                                                    <option relatedurl="#" value="ReactJs Developer">ReactJs
                                                        Developer</option>
                                                    <option relatedurl="#" value="Sr. Laravel Developer">Sr. Laravel
                                                        Developer</option>
                                                    <option relatedurl="#" value="Sr. QA Engineer">Sr. QA
                                                        Engineer</option>
                                                    <option relatedurl="#" value="WordPress Developer">WordPress
                                                        Developer</option>
                                                </select>
                                                ...
                                                <script>
                                                    $(function() {
                                                        ...
                                                        $('#dynamic_select').on('change', function() {
                                                            ...
                                                            } else if (value == 'Business Analyst') {
                                                                $("#careers-detail-box")
                                                                    .html(`<div class="detail-title">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-lg-4 mb-5">
                                                    <input data-ref="careers_age" type="text" class="age effect-1"
                                                        name="careers_age" placeholder="" required><label
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="fnt"><input
                                                                ...
                                                                class="full-name" name="careers_educations_ssc[]">
                                                        </td>
                                                        <td class="fnt"><input
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="fnt"><input
                                                                ...
                                                                class="full-name" name="careers_educations_hsc[]">
                                                        </td>
                                                        <td class="fnt"><input
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-lg-4">
                                                    <input data-ref="careers_present_salary" type="text"
                                                        ...
                                                        placeholder=""><label class="required" required>Present
                                                        Salary</label>
                                                    <span class="focus-border"></span>
                                                </div>
                                        ...
                                        <!-- <button type="submit" value="submit" id="btn1_submit">submit</button> -->
                                        <!-- </form>
                                        <form action="{{ route('form.store2') }}" method="POST" class="apply-now-form">
                                            @csrf -->
                                        ...
                                        <div class="skill d-inline-block mr-top-80 w-100">
                                            ...
                                            <div class="colm-one">
                                                <textarea data-ref="careers_technical_skills" rows="1" cols="1"
                                                    ...
                                                    class="message effect-1"></textarea><label class="required"
                                                    required>Your
                                                    Technical
                                        ...
                                        <div class="more-about-you d-inline-block w-100 mr-top-80">
                                            ...
                                            <div class="colm-one mr-top">
                                                <textarea data-ref="careers_reason_for_looking_job" rows="1" cols="1"
                                                    name="careers_reason_for_looking_job" class="message effect-1"
                                                    required></textarea><label class="required">Reason
                                                    for looking job
                                            ...
                                            <!-- <button type="submit" value="submit" id="btn2_submit">submit</button> -->
                                    </form>
                                    <!-- <form action="/store" method="POST" class="apply-now-form"> -->
                                    @csrf
                                    <div class="colm-one mr-top upload-file">
                                        ...
                                        <div class="g-recaptcha brochure__form__captcha" data-sitekey="YOUR SITE KEY">
                                        </div>
                                    </div>
                                    <!-- </form> -->
                                </div>
...
<script>
    $(document).ready(function() {
        ...
        //     var userImage = document.getElementById("btn1_submit");
        //     var hangoutButton = document.getElementById("btn2_submit");
        ...
        if (positionId != 1) {
            ...
            if (positionId == 'Business Analyst') {
                $("#careers-detail-box")
                    .html(`<div class="detail-title">
                                                                        <h1>Business Analyst</h1>
                                                                        <p>Surat</p>
