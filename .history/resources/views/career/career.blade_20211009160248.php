                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="content-box">
                                ...
                                <p>Send your resume on <a href="mailto:hrwebitoinfotech@gmail.com">hr@webitoinfotech.com</a>
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="our-perks-box">
                        <picture>
                            <img alt="icon-five-days-week" srcset="/assets/img/career/icon-five-days-week1.svg">
                        </picture>
                        <!---->
                        <h3>5 Days a Week</h3>
                        <!---->
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="our-perks-box">
                        <picture>
                            <img alt="icon-flexible-hours" srcset="/assets/img/career/icon-flexible-hours1.svg">
                        </picture>
                        <!---->
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="our-perks-box">
                        <picture>
                            <img alt="icon-wfh" srcset="/assets/img/career/icon-wfh.svg">
                        </picture>
                        <!---->
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="our-perks-box">
                        <picture>
                            <img alt="icon-onsite-opportunities" srcset="/assets/img/career/icon-onsite-opportunities1.svg">
                        </picture>
                        <!---->
                        <h3>Training</h3>
                        <!---->
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="our-perks-box">
                        <picture>
                            <img alt="icon-rewards" srcset="/assets/img/career/icon-rewards1.svg">
                        </picture>
                        <!---->
                        <h3>Rewards</h3>
                        <!---->
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="our-perks-box">
                        <picture>
                            <img alt="icon-tour-and-picnics" srcset="/assets/img/career/icon-tour-and-picnics1.svg">
                        </picture>
                        <!---->
                        <h3>Team Building</h3>
                        <!---->
            ...
            <div class="team-testimonial-slider" role="toolbar">
                ...
                <div class="team-col" tabindex="-1" role="option" aria-describedby="slick-slide00" style="">
                    <div class="team-testimonial-content">
                        <div class="img-box"><img alt="" src="assets/img/team/jainish.png">
                        </div>
                        ...
                        <div class="team-profile">
                            <!---->
                            <h6>Jainish Bhimani</h6>
                            <!----><span>Sr. Business Development Manager, Web Developer</span>
                        </div>
                    </div>
                </div>
                <div class="team-col" tabindex="-1" role="option" aria-describedby="slick-slide01" style="">
                    <div class="team-testimonial-content">
                        <div class="img-box"><img alt="" src="assets/img/team/divyaraj.png">
                        </div>
                ...
                <div class="team-col" tabindex="-1" role="option" aria-describedby="slick-slide02" style="">
                    <div class="team-testimonial-content">
                        <div class="img-box"><img alt="" src="assets/img/team/satyam.png">
                        </div>
                ...
                <div class="team-col" tabindex="-1" role="option" aria-describedby="slick-slide03" style="">
                    <div class="team-testimonial-content">
                        <div class="img-box"><img alt="" src="assets/img/team/prachi.png">
                        </div>
                ...
                <div class="team-col" tabindex="-1" role="option" aria-describedby="slick-slide04" style="">
                    <div class="team-testimonial-content">
                        <div class="img-box"><img alt="" src="assets/img/team/chelsi.png">
                        </div>
                ...
                <div class="team-col" tabindex="-1" role="option" aria-describedby="slick-slide05" style="">
                    <div class="team-testimonial-content">
                        <div class="img-box"><img alt="" src="assets/img/team/shivani.png">
                        </div>
    ...
    <section class="dedicated-faqs pad-t-b">
        ...
        <div class="container">
            ...
            <ul class="collapsible" data-collapsible="expandable">
                ...
                <li>
                    <div class="collapsible-header card-title"><i class="fa fa-angle-right" aria-hidden="true"></i><a>What
                            is
