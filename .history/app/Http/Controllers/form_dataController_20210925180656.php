...
class form_dataController extends Controller
{
    public function storeInformation2(Request $request)
    {
        ...
        $new1->position_applied = $request->careers_applied_position;
        ...
        Mail::send('email-template', $data, function ($message) use ($u_name) {
            $message->to('shivalisavaliya012@gmail.com', 'Webito Infotech')->subject('Laravel Basic Testing Mail');
            $message->from('test@webitoinfotech.com', 'Webito Infotech');
        });
