                        ...
                        <div class="col-12 col-sm-12 col-md-12 wow zoomIn">
                            <div class="work-process-info">
                                ...
                                <div class="work-process-point row">
                                    <div class="image-grid col-12 show-more-item" role="toolbar">
                                        <div class="image-grid__item col-4">
                                            <a class="grid-item">
                                                <div class="grid-item__image ng-lazyloaded"
                                                    style="background-image: url('/assets/img/our_events/Birthday_celebration_2022.webp')">
                                                </div>
                                        ...
                                        <div class="image-grid__item col-4">
                                            <a class="grid-item">
                                                <div class="grid-item__image ng-lazyloaded"
                                                    style="background-image: url(/assets/img/our_events/ceo_birthday_2021.webp)">
                                                </div>
                                                <div class="grid-item__hover"></div>
                                                <div class="grid-item__name"></div>
                                            </a>
                                        ...
                                        <div class="image-grid__item col-4">
                                            <a class="grid-item">
                                                <div class="grid-item__image"
                                                    style="background-image: url(/assets/img/our_events/Birthday_celebration_boys_2022.webp)">
                                                </div>
                                                <div class="grid-item__hover"></div>
                                            </a>
                                        </div>
                                    ...
                                    <div class="image-grid col-12 show-more-item" role="toolbar">
                                        <div class="image-grid__item col-4">
                                            <a class="grid-item">
                                                <div class="grid-item__image ng-lazyloaded"
                                                    style="background-image: url(/assets/img/our_events/cristmas_2021.webp)">
                                                </div>
                                                <div class="grid-item__hover"></div>
                                            </a>
                                        </div>
                                        ...
                                        <div class="image-grid__item col-4">
                                            <a data-toggle="modal" class="grid-item"
                                                ...
                                                <div class="grid-item__image ng-lazyloaded"
                                                    style="background-image: url(/assets/img/our_events/anniversary_celebration_2022.webp)">
                                                </div>
                                        ...
                                        <div class="image-grid__item col-4">
                                            <a class="grid-item">
                                                <div class="grid-item__image ng-lazyloaded"
                                                    style="background-image: url(/assets/img/our_events/Award_Ceremony_2022.webp)">
                                                </div>
                                                <div class="grid-item__hover"></div>
                                            </a>
                                        </div>
                                    ...
                                    <div class="image-grid col-12 show-more-item" style="display: none;" role="toolbar">
                                        <div class="image-grid__item col-4">
                                            <a data-toggle="modal" class="grid-item"
                                                ...
                                                <div class="grid-item__image ng-lazyloaded"
                                                    style="background-image: url(/assets/img/our_events/family_2022.webp)">
                                                </div>
                                                <div class="video-play-button">
                                                    <span></span>
                                                </div>
                                        ...
                                        <div class="image-grid__item col-4">
                                            <a class="grid-item">
                                                <div class="grid-item__image ng-lazyloaded"
                                                    style="background-image: url(/assets/img/our_events/formal_2022.webp)">
                                                </div>
                                                <div class="grid-item__hover"></div>
                                            </a>
                                        </div>
                                        ...
                                        <div class="image-grid__item col-4">
                                            <a class="grid-item">
                                                <div class="grid-item__image"
                                                    style="background-image: url(/assets/img/our_events/fun_2022.webp)">
                                                </div>
                                                <div class="grid-item__hover"></div>
                                            </a>
                                        </div>
                                    ...
                                    <div class="image-grid col-12 show-more-item" style="display: none;" role="toolbar">
                                        <div class="image-grid__item col-4">
                                            <a class="grid-item">
                                                <div class="grid-item__image ng-lazyloaded"
                                                    style="background-image: url(/assets/img/our_events/party_time_2022.webp)">
                                                </div>
                                                <div class="grid-item__hover"></div>
                                            </a>
                                        </div>
                                        ...
                                        <div class="image-grid__item col-4">
                                            <a class="grid-item">
                                                <div class="grid-item__image ng-lazyloaded"
                                                    style="background-image: url(/assets/img/our_events/holi_2022.webp)">
                                                </div>
                                                <div class="grid-item__hover"></div>
                                            </a>
                                        </div>
                                        ...
                                        <div class="image-grid__item col-4">
                                            <a data-toggle="modal" class="grid-item"
                                                ...
                                                <div class="grid-item__image ng-lazyloaded"
                                                    style="background-image: url(/assets/img/our_events/Guru_purnima_2022.webp)">
                                                </div>
                                                <div class="video-play-button">
                                                    <span></span>
                                                </div>
                                    ...
                                    <div class="image-grid col-12 show-more-item" style="display: none;" role="toolbar">
                                        <div class="image-grid__item col-4">
                                            <a class="grid-item">
                                                <div class="grid-item__image ng-lazyloaded"
                                                    style="background-image: url(/assets/img/our_events/employe_one_year_2022.webp)">
                                                </div>
                                                <div class="grid-item__hover"></div>
                                            </a>
                                        </div>
                                        ...
                                        <div class="image-grid__item col-4">
                                            <a class="grid-item">
                                                <div class="grid-item__image ng-lazyloaded"
                                                    style="background-image: url(/assets/img/our_events/award_2022.webp)">
                                                </div>
                                                <div class="grid-item__hover"></div>
                                            </a>
                                        </div>
                                    ...
                                    <div class="image-grid col-12 show-more-item" style="display: none;" role="toolbar">
                                        <div class="image-grid__item col-4">
                                            <a class="grid-item">
                                                <div class="grid-item__image ng-lazyloaded"
                                                    style="background-image: url(/assets/img/our_events/farewell_2022.webp)">
                                                </div>
                                                <div class="grid-item__hover"></div>
                                            </a>
                                        </div>
                                ...
                                <div class="show-more-btn d-grid gap-2 col-6 mx-auto"
                                    style="width: 121px;background: #4675e8;color: white; padding: 19px;display: flex;border-radius:32px;">
                                    Load More</div>
