...
<main id="main">
    ...
    <section id="why-us" class="wow fadeIn">
        ...
        <div class="container-fluid">
            <div class="row counters">
                ...
                <div class="col-lg-3 col-6 text-center media-query-by-p">
                    <h1><span class="counter">75840</span></h1>
                    <p>Hours Of Support</p>
                </div>
                <div class="col-lg-3 col-6 text-center media-query-by-p">
                    <h1><span class="counter">27</span></h1>
                    <p>Hard Workers</p>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <section class="customer-logos slider slik-container ">
                    <div class="slide side-img-p"><img src="assets/img/team/sm_img.webp" class="grid__item-img p-img">
                    </div>
                    <div class="slide side-img-p"><img src="assets/img/team/av_img.webp" class="grid__item-img p-img">
                    </div>
                    <div class="slide side-img-p"><img src="assets/img/team/kp_img.webp" class="grid__item-img p-img">
                    </div>
                    <div class="slide side-img-p"><img src="assets/img/team/cv_img.webp" class="grid__item-img p-img">
                    </div>
                    <div class="slide side-img-p"><img src="assets/img/team/ra_img.webp" class="grid__item-img p-img">
                    </div>
                    <div class="slide side-img-p"><img src="assets/img/team/ss_img.webp" class="grid__item-img p-img">
                    </div>
                    <div class="slide  side-img-p"><img src="assets/img/team/dr_img.webp" class="grid__item-img p-img">
                    </div>
                    <div class="slide side-img-p"><img src="assets/img/team/dj_img.webp" class="grid__item-img p-img">
                    </div>
                    <div class="slide side-img-p"><img src="assets/img/team/jd_img.webp" class="grid__item-img p-img">
                    </div>
                    <div class="slide side-img-p"><img src="assets/img/team/rk_img.webp" class="grid__item-img p-img">
                    </div>
                    <div class="slide side-img-p"><img src="assets/img/team/am_img.webp" class="grid__item-img p-img">
                    </div>
                    <div class="slide side-img-p"><img src="assets/img/team/lm_img.webp" class="grid__item-img p-img">
                    </div>
                    <div class="slide side-img-p"><img src="assets/img/team/pm_img.webp" class="grid__item-img p-img">
                    </div>
                    <div class="slide side-img-p"><img src="assets/img/team/nb_img.webp" class="grid__item-img p-img">
                    </div>
                    <div class="slide side-img-p"><img src="assets/img/team/vp_img.webp" class="grid__item-img p-img">
                    </div>
                    <div class="slide side-img-p"><img src="assets/img/team/hv_img.webp" class="grid__item-img p-img">
                    </div>
                    <div class="slide side-img-p"><img src="assets/img/team/rc_img.webp" class="grid__item-img p-img">
                    </div>
                    <div class="slide side-img-p"><img src="assets/img/team/db_img.webp" class="grid__item-img p-img">
                    </div>
                    <div class="slide side-img-p"><img src="assets/img/team/cm_img.webp" class="grid__item-img p-img">
                    </div>
                    <div class="slide side-img-p"><img src="assets/img/team/dt_img.webp" class="grid__item-img p-img">
                    </div>
                    <div class="slide side-img-p"><img src="assets/img/team/cs_img.webp" class="grid__item-img p-img">
                    </div>
                </section>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-6 wow fadeInUp">
                    <div class="member">
                        <img src="assets/img/index/team/manav.jpg" class="img-fluid" alt="manav-kanpariya">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-6 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="member">
                        <img src="assets/img/index/team/brijesh.jpg" class="img-fluid" alt="brijesh-goyani">
                        <div class="member-info">
                            <div class="member-info-content">
        ...
        <div class="container">
            ...
            <div class="customer-logos slider">
                ...
                <a href="https://www.livecake.in/">
                    <div class="slide"><img src="assets/img/index/clients/Cake-factory.png" alt="Cake Factory"></div>
                </a>
                ...
                <a href="">
                    <div class="slide"><img src="assets/img/index/clients/Leafberry-herbal.png" alt="Leafberry Herbal">
                    </div>
                </a>
                ...
                <a href="https://princejewellery.in/">
                    <div class="slide"><img src="assets/img/index/clients/Prince-jewellery.png" alt="Prince Jewellery">
                    </div>
                </a>
    ...
    <div id="testimonials">
        <div id="testimonial" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                ...
                <div class="carousel-item {{ $loop->first ? 'active' : '' }}">
                    <div class="carousel-caption">
                        <img src="{{ asset('backend/images/testimonials/' . $tm->images_path) }}" class="img-fluid"
                            alt="testimonials">
            ...
            <a class="carousel-control-next" href="#testimonial" data-slide="next"> <i class="fa fa-arrow-right"></i>
            </a>
        </div>
    </div>
     <script src="https://code.jquery.com/jquery-2.2.0.min.js" type="text/javascript"></script>
